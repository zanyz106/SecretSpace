...
public class IActivityManagerHookHandle extends BaseHookHandle {
  ...
  private static class startService extends ReplaceCallingPackageHookedMethodHandler {
    ...
    @Override
    protected boolean beforeInvoke(Object receiver, Method method, Object[] args) throws Throwable {
      int intentIndex0 = findFirstIntentIndexInArgs(args);
      if (intentIndex0 >= 0 && intentIndex0 < args.length) {
        android.util.Log.e(TAG, "to startService " + args[intentIndex0]);
      }
      //API 2.3, 15, 16
  ...
  private static class bindService extends ReplaceCallingPackageHookedMethodHandler {
    ...
    @Override
    protected boolean beforeInvoke(final Object receiver, Method method, Object[] args) throws Throwable {
      int intentIndex0 = findFirstIntentIndexInArgs(args);
      if (intentIndex0 >= 0 && intentIndex0 < args.length) {
        android.util.Log.e(TAG, "to bind host" + args[intentIndex0]);
      }
      //API 2.3, 15
      ...
      if (info != null && index >= 0) {
        android.util.Log.e(TAG, "replaceFirstServiceIntentOfArgs " + args[intentIndex0]);
      ...
      // TODO: 16/9/6 00001: gms crash
      //gms crash begin
      //bind gms crash, return true to not bind it
      else if (index >= 0) {
        int intentIndex = findFirstIntentIndexInArgs(args);
        if (intentIndex >= 0 && intentIndex < args.length) {
          Intent intent = (Intent) args[intentIndex];
          if (intent != null && "com.google.android.gms".equals(intent.getPackage())) {
            return true;
          }
          if (intent != null && !intent.getPackage().startsWith("android")) {
            Log.e(TAG, "to bind unknown host" + intent);
          }
        }
      }
      //gms crash end
    ...
    protected void afterInvoke(Object receiver, Method method, Object[] args, Object invokeResult) throws Throwable {
      ...
      // TODO: 16/9/6 00001: gms crash
      //gms crash begin
      //set fake bind result 0, means unknown host
